...
<body>
	<header>
		...
		<nav>
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						<div class="modal-header">
							<h1 class="modal-title fs-5" id="searchModalLabel">행사를
								찾아보세요!</h1>
			...
			<div class="container">
				<form action="https://www.google.com/search" class="search"
					...
					<input type="search" placeholder="Type something..." name="q"
						class="search__input" data-bs-toggle="modal"
						data-bs-target="#searchModal" />

					<div class="search__button" id="search-button">
						<i class="ri-search-2-line search__icon"></i> <i
							class="ri-close-line search__close"></i>
					</div>
				</form>
			</div>
			<!-- </a> -->
			...
			<a href=""><i class="fa-solid fa-circle-exclamation"
				style="color: #938f9e"></i></a>
